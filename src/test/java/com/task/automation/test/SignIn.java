...
//	}
	...
	public void verifyCreateNewUserWithValid() throws Exception {
		...
		Thread.sleep(5000);
		boolean bol = sip.errMessageGL.isDisplayed();
		assertEquals(bol,true);
//		sip.glewisusername.sendKeys(JsonUtil.getTestData("username"));
//		sip.glewispassword.sendKeys(JsonUtil.getTestData("password"));
//		sip.glewissubmit.click();
...
//		Thread.sleep(5000);
		...
		sip.enrolDateStu.sendKeys(JsonUtil.getTestData("enroldate"));
